...
(cl:defmethod cl:initialize-instance :after ((m <Point>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_demo-msg:<Point> is deprecated: use msgs_demo-msg:Point instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Point>)))
  ...
  (cl:format cl:nil "#空间中的点的位置~%#位置:geometry_msgs/Point.msg~%~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Point)))
  "Returns full string definition for message of type 'Point"
  (cl:format cl:nil "#空间中的点的位置~%#位置:geometry_msgs/Point.msg~%~%float64 x~%float64 y~%float64 z~%~%~%"))
