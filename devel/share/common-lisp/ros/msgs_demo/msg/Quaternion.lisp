...
(cl:defmethod cl:initialize-instance :after ((m <Quaternion>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Quaternion)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_demo-msg:<Quaternion> is deprecated: use msgs_demo-msg:Quaternion instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Quaternion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:x-val is deprecated.  Use msgs_demo-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Quaternion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:y-val is deprecated.  Use msgs_demo-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Quaternion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:z-val is deprecated.  Use msgs_demo-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'w-val :lambda-list '(m))
(cl:defmethod w-val ((m <Quaternion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:w-val is deprecated.  Use msgs_demo-msg:w instead.")
  (w m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Quaternion>)))
  ...
  (cl:format cl:nil "#消息代表空间中旋转的四元数~%#位置:geometry_msgs/Quaternion.msg~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Quaternion)))
  "Returns full string definition for message of type 'Quaternion"
  (cl:format cl:nil "#消息代表空间中旋转的四元数~%#位置:geometry_msgs/Quaternion.msg~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
