...
if(NOT "/home/akingse/tutorial_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'topic_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/akingse/tutorial_ws/src/my_demo/topic_demo/${idir}'.  ${_report}")
    endif()
